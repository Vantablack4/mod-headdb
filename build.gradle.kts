...
val modPermissionsVersion = providers.gradleProperty("mod_permissions_version").orElse("0.1.0").get()
val modCharactersVersion = providers.gradleProperty("mod_characters_version").orElse("0.1.38").get()
...
dependencies {
    ...
    implementation("com.vantablack4.mc:mod-permissions:$modPermissionsVersion")
    implementation("com.vantablack4.mc:mod-characters:$modCharactersVersion")

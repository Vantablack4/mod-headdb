...
public final class SearchCategoryCommand extends AbstractPaperCommand {

    private static final Argument<String> CATEGORY = Argument.required("category", PaperArgumentTypes.STRING);

    private final HeadDBPlugin plugin;

    public SearchCategoryCommand(@NotNull HeadDBPlugin plugin) {
    ...
    protected @NotNull Command buildCommand() {
        return PaperCommands.literal("category")
                .description("Searches heads by category.")
